        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PledgePrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookDetails_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookDetails_Locations_DropUpLocationId",
                        column: x => x.DropUpLocationId,
                        principalTable: "Locations",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BookDetails_Locations_PickUpLocationId",
                        column: x => x.PickUpLocationId,
                        principalTable: "Locations",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookDetails_BookingId",
                table: "BookDetails",
                column: "BookingId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BookDetails_DropUpLocationId",
                table: "BookDetails",
                column: "DropUpLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_BookDetails_PickUpLocationId",
                table: "BookDetails",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarLocations_CarId_LocationId",
                table: "CarLocations",
                columns: new[] { "CarId", "LocationId" },
                unique: true);
